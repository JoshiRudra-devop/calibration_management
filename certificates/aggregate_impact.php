...
$pageTitle  = 'Aggregate Impact Value App Calibration';
$activePage = 'certificate';
include __DIR__ . '/../includes/header.php';

$db = getDB();
$stmt = $db->prepare("SELECT * FROM instrument_types WHERE slug = 'aggregate_impact' LIMIT 1");
$stmt->execute();
...
<div class="container">
  ...
  <script>
    ...
    const INSTRUMENT_SLUG = 'aggregate_impact';
  </script>
  <script>
