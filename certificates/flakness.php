...
$pageTitle  = 'Flakness Calibration';
$activePage = 'certificate';
include __DIR__ . '/../includes/header.php';

$db = getDB();
$stmt = $db->prepare("SELECT * FROM instrument_types WHERE slug = 'flakness' LIMIT 1");
$stmt->execute();
...
<div class="container">
  ...
  <script>
    ...
    window.INSTRUMENT_SLUG = 'flakness';
  </script>
  ...
  <script>
    ...
    doc.text(`SERIAL NO:- ${details.serialNo}`, 150, Yalign);
