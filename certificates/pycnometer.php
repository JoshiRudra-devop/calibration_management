...
$pageTitle  = 'Pycnometer Calibration';
$activePage = 'certificate';
include __DIR__ . '/../includes/header.php';

$db = getDB();
$stmt = $db->prepare("SELECT * FROM instrument_types WHERE slug = 'pycnometer' LIMIT 1");
$stmt->execute();
...
<div class="container">
    <h2 class="centered">PYCNOMETER   BOTTLE CALIBRATION CERTIFICATE</h2>
      ...
      <div class="title_input_pair">
        ...
        <select id="size">
          <option value="750 ML">750 </option>
           <option value="1000 ML">1000 </option>
  ...
  <script>
    ...
    window.INSTRUMENT_SLUG = 'pycnometer';
  </script>
  <script>
...
window.addCertificateDetails = function(doc, details)
{
  ...
  doc.text(`EQUIPMENT NAME      :     PYCNOMETER   BOTTLE   `, 14, Yalign+=15);
