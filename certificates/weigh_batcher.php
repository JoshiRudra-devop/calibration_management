...
$pageTitle  = 'Weigh Batcher Calibration';
$activePage = 'certificate';
include __DIR__ . '/../includes/header.php';

$db = getDB();
$stmt = $db->prepare("SELECT * FROM instrument_types WHERE slug = 'weigh_batcher' LIMIT 1");
$stmt->execute();
...
<div class="container">
  ...
  <script>
    ...
    window.INSTRUMENT_SLUG = 'weigh_batcher';
  </script>
  ...
  <script>
    ...
    window.addCertificateDetails = function(doc, details) {
      ...
      // Add calibrated by
      let endY = (typeof tableStartY2 !== "undefined" ? tableStartY2 : (doc.lastAutoTable ? doc.lastAutoTable.finalY : Yalign)) + 4;
      doc.setFont("helvetica", "bold");
