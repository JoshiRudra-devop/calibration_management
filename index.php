            ...
            <?php else: ?>
              ...
              ?>
                <tr class="cert-row" style="border-bottom: 1px solid var(--border); transition: background 0.15s;" data-search="<?= htmlspecialchars(strtolower($cert['cert_number'] . ' ' . $cert['party_name'] . ' ' . $cert['site_location'] . ' ' . $cert['instrument_label'])) ?>">
                  ...
                  <td style="padding: 1rem 0.75rem;"><span style="background: var(--accent-lt); color: var(--primary-dk); padding: 0.25rem 0.6rem; border-radius: 4px; font-size: 0.85rem; font-weight: 600;"><?= htmlspecialchars($cert['instrument_label']) ?></span></td>
